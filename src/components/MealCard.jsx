...
// //       className="cursor-pointer bg-white rounded-xl overflow-hidden shadow hover:shadow-lg transform hover:-translate-y-1 transition"
// //     >
// //       <div className="w-full aspect-w-16 aspect-h-9">
// //         {/* Use object-cover to keep images nice */}
