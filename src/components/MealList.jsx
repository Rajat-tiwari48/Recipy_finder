...
// //     return (
// //       <div className="py-8 px-4 max-w-3xl mx-auto text-center text-gray-500">
// //         Try searching for an ingredient to see results.
// //       </div>
// //     );
// //   }
...
// //         {meals.map((meal) => (
// //           <MealCard key={meal.idMeal} meal={meal} onClick={handleOpen} />
// //         ))}
// //       </div>
// //     </div>
// //   );
